...
public class EntityTests
{
    ...
    public void CreateDefinitionForCollegeEntities()
    {
        ...
        var student = db
            ...
            .SetNaming("Student")
            .SetColumnFor(e => e.FirstName, 10)
            .SetColumnFor(e => e.MiddleName, 10, true)
            .SetColumnFor(e => e.LastName, 10)
            .SetColumnFor(e => e.Gender, 1)
            .SetIdentity(e => e.Id)
            .SetPrimaryKey(e => e.Id)
            ;

        student
            .AddExtendedProp(e => e.FirstName, "MS_Description", "First name")
            .AddExtendedProp(e => e.MiddleName, "MS_Description", "Middle name")
            .AddExtendedProp(e => e.LastName, "MS_Description", "Last name")
            ;
        ...
        course
            .AddExtendedProp(e => e.Name, "MS_Description", "Course name")
            ;

        var courseStudent = db
            .DefineEntity(new { Id = 0, CourseId = 0, StudentId = 0 })
        ...
        courseStudent
            .AddExtendedProp(e => e.CourseId, "MS_Description", "Course Id")
            .AddExtendedProp(e => e.CourseId, "MS_Description", "Student Id")
            ;
